...
function addUi() {
  ...
  const row = panel.querySelector('#cinematic-director-tools') || panel.querySelector('.row') || panel;
  ...
  status.id = 'vr180-status'; status.style.cssText = 'flex-basis:100%;margin-top:2px;color:#a9bad0;font:11px system-ui';
